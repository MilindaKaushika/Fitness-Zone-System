...
namespace Fitness_Zone.Biz
{
    class Annual : member
    {
        ...
        public Annual() { }
        public Annual(string cid, string fname, string lname, string dob,
        ...
        {
            string quary = "exec registermb '" + this.MemberID + "','" +
        ...
        {
            string quary = "exec updatembanuual'" + this.MemberID + "','" +
